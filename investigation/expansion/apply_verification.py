...
def main():
    ...
    ap.add_argument("--base", type=Path,
                    default=Path("data/FakenewsBR_v3_provenance.csv"))
    ap.add_argument("--v2", type=Path,
                    default=Path("data/FakenewsBR_sanitized_v3.csv"))
    ap.add_argument("--matches", type=Path,
                    default=Path("data/FakenewsBR_v2_factcheck_matches.csv"))
    ap.add_argument("--corrob", type=Path,
                    default=Path("data/FakenewsBR_v2_news_verification.csv"))
    ap.add_argument("--local", type=Path,
                    default=PROC / "local_verify_results.jsonl")
    ap.add_argument("--out", type=Path, default=Path("data/FakenewsBR_v3_labels.csv"))
